...
heuristics = {
    "all_heuristics": lambda board, goal: nearest_dist(board) + nearest_goal(board, goal) + in_direction_of_goal(board) +
                               benefit_outered_blocks(board, goal) + punish_bad_expansions(board, goal),
    "negative_distance": lambda board, goal: nearest_goal(board, goal) - nearest_dist(board) +  in_direction_of_goal(board) +
                               benefit_outered_blocks(board, goal) + punish_bad_expansions(board, goal),
    "no_punishments": lambda board, goal: nearest_dist(board) + nearest_goal(board, goal) + in_direction_of_goal(board) +
                               benefit_outered_blocks(board, goal),
...
def benefit_outered_blocks(board, nearest_goal):
